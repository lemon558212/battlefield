...
const CHARACTERS = {
  sniper: {
    name: "韓沐霜", callsign: "霜", portrait: "assets/portraits/sniper.jpg",
    line: "每一發子彈都要有名字。",
    trait: { desc: "神射手：命中 +6%", mods: { acc: 0.06 } }
  },
  mg: {
    name: "雷諾．佛斯", callsign: "老雷", portrait: "assets/portraits/mg.jpg",
    line: "我知道他們怎麼想——因為我曾是他們。",
    trait: { desc: "壓制本能：攻擊 +2、HP +40", mods: { atk: 2, hp: 40 } }
  },
  rifleman: {
    name: "丁小滿", callsign: "小滿", portrait: "assets/portraits/rifleman.jpg",
    line: "班長說跟著我走，準沒錯。",
    trait: { desc: "老兵之勇：HP +60", mods: { hp: 60 } }
  },
  assault: {
    name: "艾拉．科瓦奇", callsign: "火花", portrait: "assets/portraits/assault.jpg",
    line: "衝第一個的人，看得最清楚。",
    trait: { desc: "突擊先鋒：AP +12", mods: { ap: 12 } }
  },
  at: {
    name: "巴頓．歐克", callsign: "鐵鎚", portrait: "assets/portraits/at.jpg",
    line: "坦克？那只是比較大的靶子。",
    trait: { desc: "獵殺本能：攻擊 +3", mods: { atk: 3 } }
  },
  mortar: {
    name: "賽琳．杜瓦", callsign: "雨傘", portrait: "assets/portraits/mortar.jpg",
    line: "拋物線是世界上最誠實的曲線。",
    trait: { desc: "精算落點：命中 +5%、射程 +10", mods: { acc: 0.05, range: 10 } }
  },
  engineer: {
    name: "白老師", callsign: "白老師", portrait: "assets/portraits/engineer.jpg",
    line: "壞掉的東西都能修，人心也是。",
    trait: { desc: "巧手：HP +40、AP +8", mods: { hp: 40, ap: 8 } }
  },
  sam: {
    name: "汀娜．烏梅", callsign: "望天", portrait: "assets/portraits/sam.jpg",
    line: "天上飛的，遲早要下來。",
    trait: { desc: "鷹眼：命中 +6%", mods: { acc: 0.06 } }
  },
  specops: {
    name: "影山靜", callsign: "無聲", portrait: "assets/portraits/specops.jpg",
    line: "……（點了點頭）",
