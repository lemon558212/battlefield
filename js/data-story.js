...
const STORY = [
  { n:1,  title:"灰色黎明",   map:"tutorial", player:"taiwan",  enemy:"china",   side:1,
    ...
    dialog:[
      { who:"丁小滿", mood:"angry", text:"指揮官！雷達站起火了——不是演習，重複，不是演習！" },
      { who:"韓沐霜", pos:"right", text:"敵人沒有番號，沒有旗幟。灰色臂章……我沒見過這種編制。" },
      { who:"丁小滿", text:"守備隊只集結了一半，武器庫的門還是我踹開的。命令吧，指揮官。" },
  ...
  { n:2,  title:"平原上的旗", map:"plain",    player:"usa",     enemy:"russia",  side:0,
    ...
    dialog:[
      { who:"雷諾．佛斯", mood:"angry", text:"新隊長就是你？聽著，我不在乎你從哪來，我只在乎你會不會把人白白送死。" },
      { who:"艾拉．科瓦奇", pos:"right", mood:"smile", text:"別理老雷，他對誰都這樣。我是艾拉——衝鋒的事交給我。" },
      { who:"白老師", mood:"smile", text:"裝備我都檢修過了。孩子們，出發前記得：受傷就喊我，逞英雄的最後都躺擔架。" },
  ...
  { n:3,  title:"絞肉機重演", map:"verdun",   player:"uk",      enemy:"germany", side:0,
    ...
    dialog:[
      { who:"賽琳．杜瓦", text:"兩道鐵絲網、十二座機槍堡。放心，拋物線會替我們敲門。" },
      { who:"白老師", pos:"right", mood:"smile", text:"鐵絲網交給我。剪刀比子彈便宜，孩子們省點彈藥。" },
      { who:"雷諾．佛斯", mood:"angry", text:"這佈陣……跟教科書一模一樣。灰幕的教科書。" },
      { who:"韓沐霜", pos:"right", text:"那就用他們沒讀過的章節打。" }
    ],
  ...
  { n:4,  title:"無聲的村莊", map:"town",     player:"france",  enemy:"germany", side:0,
    ...
    dialog:[
      { who:"艾拉．科瓦奇", mood:"smile", text:"重砲全留後方？那正好，我上前面。" },
      { who:"白老師", pos:"right", text:"民宅裡有人住。每一發子彈，都想清楚再打。" },
  ...
  { n:5,  title:"沙暴走廊",   map:"desert",   player:"usa",     enemy:"iran",    side:0,
    ...
    dialog:[
      ...
      { who:"巴頓．歐克", mood:"angry", text:"跑掉一輛坦克，我就追上去親手拆一輛。" },
      { who:"賽琳．杜瓦", pos:"right", text:"沙暴會吃掉拋物線。這一場，我的傘借給飛行員。" },
      { who:"韓沐霜", pos:"right", text:"他們的防空飛彈還在某處盯著天。汀娜，天空交給你。" }
    ],
  ...
  { n:6,  title:"林海伏擊",   map:"forest",   player:"vietnam", enemy:"thailand",side:1,
    ...
    dialog:[
      ...
      { who:"韓沐霜", pos:"right", mood:"angry", text:"把伏擊者變成獵物。曙光——反咬。" }
    ],
  ...
  { n:8,  title:"紅色灘頭",   map:"beach",    player:"japan",   enemy:"china",   side:0,
    ...
    dialog:[
      ...
      { who:"丁小滿", pos:"right", mood:"smile", text:"浪好大……我會暈船，但我不暈戰場！" },
  ...
  { n:9,  title:"海峽封鎖線", map:"strait",   player:"korea",   enemy:"japan",   side:0,
    ...
    dialog:[
      ...
      { who:"汀娜．烏梅", pos:"right", mood:"angry", text:"霧裡有東西在飛。雷達看不清的，我的眼睛看得清。" },
  ...
  { n:10, title:"霧港疑雲",   map:"harbor",   player:"uk",      enemy:"russia",  side:0,
    ...
    dialog:[
      ...
      { who:"艾拉．科瓦奇", pos:"right", mood:"angry", text:"前五回合不准開火？這比叫我衝鋒難一百倍。" },
      { who:"雷諾．佛斯", mood:"angry", text:"內鬼就躲在貨櫃後面。這一次，換我來揭別人的面具。" },
  ...
  { n:11, title:"群山之肩",   map:"verdun",   player:"taiwan",  enemy:"korea",   side:0,
    ...
    dialog:[
      ...
      { who:"巴頓．歐克", pos:"right", text:"棱線後面的砲，一門一門敲掉。" },
  ...
  { n:12, title:"鋼鐵洪流",   map:"plain",    player:"ukraine", enemy:"russia",  side:1,
    ...
    dialog:[
      ...
      { who:"巴頓．歐克", pos:"right", mood:"angry", text:"三波裝甲？那叫三批靶子。" },
  ...
  { n:13, title:"孤島要塞",   map:"strait",   player:"usa",     enemy:"iran",    side:0,
    ...
    dialog:[
      ...
      { who:"賽琳．杜瓦", pos:"right", text:"兵工廠的爐火燒了三年。今天，讓它降溫。" },
  ...
  { n:15, title:"黎明線",     map:"urban",    player:"usa",     enemy:"russia",  side:0,
    ...
    dialog:[
      ...
      { who:"雷諾．佛斯", pos:"right", mood:"angry", text:"灰王想看正規軍為何而戰。那就給他看。" },
